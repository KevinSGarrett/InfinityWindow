...
- [~] **Enhanced retrieval & context shaping**  
  - [x] Phase 0/1: centralized retrieval profiles with env-configurable `top_k`/thresholds applied to chat/search for messages/docs/memory (`CONFIG_ENV.md`).  
  - [~] Per‑feature retrieval tuning (tasks vs docs vs memory) and strategy selection.  
  - [~] Future: telemetry-driven tuning and deeper context shaping beyond current profiles.  
