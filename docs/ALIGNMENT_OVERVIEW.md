...
- Docs: `docs/REQUIREMENTS_CRM.md`, `docs/TODO_CHECKLIST.md` (§2, §6), `docs/PROGRESS.md` (2025-12-10 Autonomous TODO v2), `docs/USER_MANUAL.md` (§6.2–6.4), `docs/USAGE_TELEMETRY_DASHBOARD.md`.
